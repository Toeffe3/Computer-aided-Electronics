/**
 * Style class
 * @decsription Class used for applying styles to html5 canvas elements.
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D CanvasRenderingContext2D on MDN}
 * @module style
 */
...
export default class Style {
	...
	constructor() {
		...
		/** @type {number} */
		this.globalAlpha = 1;
		/** @type {"source-over"|"source-in"|"source-out"|"source-atop"|"destination-over"|"destination-in"|"destination-out"|"destination-atop"|"lighter"|"copy"|"xor"} */

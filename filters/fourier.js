...
class FourierSeries {
    ...
    // return a arrow function that represents the fourier series
    /**
     * Returns a function that represents the fourier series.
     * @returns {(x: number)=>number} (x: number)=>number
     * @example
     ...
     * @param {(x: number)=>number} f - The function.
    ...
    *[Symbol.iterator]() {
     ...
     * @typedef {any<T>} AnyDimensionalArray<T>
     */
